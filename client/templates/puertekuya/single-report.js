Template.singlePuerteReport.rendered = function(){
...
Template.singlePuerteReport.helpers({
	'hideHelped': function(){
    var reportId = this.caseNumber,
    report = Puerteoffgrid.findOne({caseNumber: reportId}),
...
Template.singlePuerteReport.events({
  'click .contact-me': function(){
    ...
    var to = 'enefchile@gmail.com',
        from = name,
        subject = "Solicitiud de asistencia Solar Offgrid Puertekuya - Cotizador Enef",
        text = "Alguien ha solicitado asistencia con su cotizacion de paneles offgrid Condominio Puertekuya" + "\n\n" +
               "Nombre: " + name + "\n" +
               "Email de contacto: " + email + "\n" +
               "Numero de caso: " + caseNumber + "\n\n" + 
               "Dirección de consulta: http://cotizadorsolar.cl/cotizacion-puertekuya-offgrid/"+caseNumber;
    Meteor.call('sendEmail', to,from,subject,text);
    Meteor.call('askedHelpOffgridPuerte', reportId);
