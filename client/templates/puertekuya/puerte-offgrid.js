Template.puerteReport.onRendered(function(){
	$('select').material_select();
	$('.tooltipped').tooltip({delay: 50});
});

Template.puerteReport.helpers({
	'aincTotal': function(){
...
Template.puerteReport.events({
	...
	'submit .puerte-off-grid-form': function(e){
		e.preventDefault();
      ...
      var message = "Estimado " +cName+ "," + "\n\n" +
      							...
      							"Tomando en cuenta el factor de radiación solar del Condominio Puertekuya ubicado en la comuna de Navidad, VI región, se ha cotizado la instalación de un sistema fotovoltaico compuesto por paneles solares, inversor, estructuras, cables y conectores que podrá suministrarle energía para obtener el ahorro anual seleccionado." + "\n\n" +
      							
                    "Si quiere revisar y descargar su cotización diríjase a la siguiente dirección: http://cotizadorsolar.cl/cotizacion-puertekuya-offgrid/"+caseNumber+ "\n\n" +
                    ...
                    "Saludos," + "\n\n" + 
                    "Equipo de Enef";
      if(zoneReference==="centro"&&grandNum>16533){
				var message = "Estimado " +cName+ "," + "\n\n" +
      ...
      var to = email,
        ...
        text = message;						 
			if(zone===""){
				...
				var data = {
					equipment: equipment,instalation: instalation,category: category,discount:discount,
